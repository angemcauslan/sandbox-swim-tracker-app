          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <label className="block text-sm font-semibold mb-2 text-slate-700">
                  Claude API Key
                  <span className="text-xs font-normal text-slate-500 ml-2">(for AI report generation)</span>
                </label>
                <input
                  type="password"
                  value={apiKey}
                  ...
                  placeholder="sk-ant-..."
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition font-mono text-sm"
                />
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-900">
                  <strong>Note:</strong> Your API key is stored locally in your browser and never sent anywhere except to Anthropic's API when generating reports.
                </p>
              </div>
            </div>
